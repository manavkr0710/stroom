...
module.exports = {
    ...
    development: {
        PORT: 3001,
        MONGODB_URI: 'mongodb+srv://username:password@cluster.mongodb.net/Stroom',
    ...
    production: {
        ...
        MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://username:password@cluster.mongodb.net/Stroom',
